...
def plot_data(file_paths, offset=offset, broadening_sigma=sigma):
	...
	fig.savefig(f'comp_rdf_ce_mul_{_T1}_{_T2}.png', dpi=1200, bbox_inches='tight')
	fig.savefig(f'comp_rdf_ce_mul_{_T1}_{_T2}.pdf', format='pdf', dpi=1200, bbox_inches='tight')
