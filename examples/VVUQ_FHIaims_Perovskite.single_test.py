...
if __name__ == '__main__':
	...
	cell_uq = read_fhiaims_cell('/work/e05/e05/wkjee/PAX/VVUQ/Perovskite/UQ_CsPbI/Move_Atoms_E0.5.3/MoveX/summary/511_aims_init.in')

	# load final - after optimisation
	#cell_final = read_fhiaims_cell(sys.argv[2])
	cell_final = read_fhiaims_cell('/work/e05/e05/wkjee/PAX/VVUQ/Perovskite/UQ_CsPbI/Move_Atoms_E0.5.3/MoveX/summary/511_aims_final.in')
	...
	#	FHIaims extractor
	# ======
	outpath = '/work/e05/e05/wkjee/PAX/VVUQ/Perovskite/UQ_CsPbI/Move_Atoms_E0.5.3/MoveX/summary/511_aims.out'
	ex = extractor()
