...
for i,file_path in enumerate(filelist):
	...
	with open(file_path,'r') as file:
		...
		if i == 2:
			ax.plot( x,y1, color='red', label=f'300K')
			ax2.plot(x,y2, color='blue', label=f'300K')
...
fig.savefig(f'GH_Profile300K.png', dpi=1200, bbox_inches='tight')
fig.savefig(f'GH_Profile300K.pdf', format='pdf', dpi=1200, bbox_inches='tight')
