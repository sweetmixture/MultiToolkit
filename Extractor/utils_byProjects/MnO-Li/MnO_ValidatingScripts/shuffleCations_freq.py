...
def process_file(file_path,i,size):
	...
	footer_file = "/work/e05/e05/wkjee/Masters/Zirui2023/MnO/shelOnly/new_footer_freq"
	...
	with open(f"{header_file}", "r") as header_content, \
		open(f"{root}/shuffle_run_freq/A{i}.gin", "w") as output_file, \
...
if __name__ == "__main__":
	...
	os.makedirs("shuffle_run_freq", exist_ok=True)
