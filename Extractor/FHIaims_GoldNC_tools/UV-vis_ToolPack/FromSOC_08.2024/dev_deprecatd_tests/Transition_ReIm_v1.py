	...
	for nx in range(nx_max):
		...
		for ny in range(ny_max):
			for nz in range(nz_max):
				...
				trans_moment_re += rre
				trans_moment_im += im	# supposed to be rim!!!! ERROR
...
'''
	...
	* loading finished
	0  20  40  60  80 100 120 140 160 180 200 220 240 260 0.0 (array([14206.05329116, 12476.55015189, 12713.47303407]), array([0., 0., 0.]))
'''
